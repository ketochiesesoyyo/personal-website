---
title: MatchWise
tagline: Structured recruitment, clearer decisions — AI-assisted, human-controlled.
type: product
role: Director of Operations & GTM
year: "2025"
status: live
url: https://matchwise.app
stack: ["Next.js", "Python", "OpenAI", "Postgres", "Embeddings"]
metrics:
  - { label: "Screening time", value: "−80–90%" }
  - { label: "Inference cost", value: "−60%" }
featured: true
order: 3
---
