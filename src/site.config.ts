export const site = {
  ...
  email: "hello@henrickf.com",
  socials: {
    linkedin: "https://www.linkedin.com/in/henrick-farias/",
    github: "https://github.com/ketochiesesoyyo",
  },
  trackRecord: {
    companies: [
      { name: "Jeeves (a16z · YC)", url: "https://tryjeeves.com" },
      { name: "Lottus Education", url: "https://www.lottus.com" },
      { name: "MatchWise", url: "https://matchwise.app" },
      { name: "BBVA", url: "https://www.bbva.mx" },
      { name: "KoreFusion", url: "https://www.korefusion.com" },
    ],
    enterpriseAccounts: ["HSBC", "Santander", "Novartis", "Accenture"],
  },
  nav: [
